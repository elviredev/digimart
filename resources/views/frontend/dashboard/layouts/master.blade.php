        ...
        <li class="nav-menu__item has-submenu">
          ...
          <ul class="nav-submenu">
            <li class="nav-submenu__item">
              <a href="index.html" class="nav-submenu__link">
                Home
                One</a>
            </li>
            <li class="nav-submenu__item">
            ...
            <li class="nav-submenu__item">
              <a href="index-three.html" class="nav-submenu__link">
                Home
                Three</a>
            </li>
          </ul>
  ...
  <div class="dashboard__inner d-flex">
    ...
    <div class="dashboard-body">
          ...
          <div class="header-right flx-align">
            <div class="header-right__inner gap-sm-3 gap-2 flx-align d-flex">
              ...
              <div class="language-select flx-align select-has-icon">
                ...
                <img
                src="assets/images/icons/globe-white.svg" alt=""
      ...
      <div class="dashboard-footer bottom-footer-two mt-32 border-0 bg-white">
        <div class="bottom-footer__inner text-end">
          <p class="bottom-footer__text font-14">Copyright ©{{ Date('Y') }} DigiMart, All rights reserved.</p>
        </div>
      </div>

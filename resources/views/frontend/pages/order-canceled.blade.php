...
@section('content')
  ...
  <section class="payment_page  padding-y-120 overflow-hidden">
    <div class="container text-center">
      <img src="{{ asset('assets/frontend/images/thumbs/remove.png') }}" alt="">
      <h1 class="mt-3">{{ __('Order Canceled') }}</h1>
      <p class="mt-3">{{ __('Your order has been canceled.') }}</p>
      <a href="{{ route('products') }}" class="btn btn-lg btn-main mt-4">{{ __('Continue Shopping') }}</a>
    </div>
  </section>

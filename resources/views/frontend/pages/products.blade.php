                ...
                <ul class="filter-sidebar-list">
                  <li class="filter-sidebar-list__item">
                    <a href="{{ route('products') }}" class="filter-sidebar-list__text">
                      {{ __('All Categories') }} <span class="qty">{{ $productsCount }}</span>
                    </a>
                  </li>
                  @foreach($categories as $category)
                    <li class="filter-sidebar-list__item">
                      <a href="{{ route('products', ['category' => $category->slug]) }}" class="filter-sidebar-list__text">
                        {{ $category->name }} <span class="qty">{{ $category->items_count }}</span>
                      </a>
                    </li>
                  @endforeach
                </ul>
              ...
              <div class="filter-sidebar__content">
                <ul class="filter-sidebar-list">
                  <li class="filter-sidebar-list__item">
                    <div class="filter-sidebar-list__text">
                      <div class="common-check common-radio">
                        <input class="form-check-input" type="radio" value="5" name="rating" id="fiveStar">
                  ...
                  <li class="filter-sidebar-list__item">
                    <div class="filter-sidebar-list__text">
                      <div class="common-check common-radio">
                        <input class="form-check-input" type="radio" value="4" name="rating" id="fourStar">
                  ...
                  <li class="filter-sidebar-list__item">
                    <div class="filter-sidebar-list__text">
                      <div class="common-check common-radio">
                        <input class="form-check-input" type="radio" value="2" name="rating" id="twoStar">
                  ...
                  <li class="filter-sidebar-list__item">
                    <div class="filter-sidebar-list__text">
                      <div class="common-check common-radio">
                        <input class="form-check-input" type="radio" value="1" name="rating" id="oneStar">
